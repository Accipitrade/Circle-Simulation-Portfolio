...
import { CheckCC, MoveCC, GetCCVel, CheckCW, MoveCW, GetCWVel, GetMagnitude, FindCompositeVel } from './CollisionDetection.js';
...
function App() {
  ...
  const PushFrameData = () => {
    mouseFrameData.current.push([{x: mousePosition.current.x, y: mousePosition.current.y}, Date.now()]);
  }
